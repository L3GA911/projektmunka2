		  ...
		  <div class="modal-content">
			...
			<div class="content_container">
			  <div class="form_content">
				<form id="form_<?=$person["id"];?>" name="form_<?=$person["id"];?>" action="" method="post" class="child_selector child" autocomplete="off" class="child_input">
					<div>
						<input hidden type="text" id="personid" name="personid" value="<?=$person["id"];?>"><br>
						...
						<select id="numbersOfChildren" name="numbersOfChildren" onChange="addInput()"><br>
