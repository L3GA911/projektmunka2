                    ...
                    <ul>
                        ...
                        <li>
                            <div class="tooltip">
                                <a href="working_hours.php">
                                    <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-calendar-month" viewBox="0 0 16 16">
                        ...
                        <li>
                            <div class="tooltip">
                                ...
                                <span class="tooltiptext">Dolgozói profilok szerkesztése</span>
                            </div>
                        </li>
                        <li>
                            <div class="tooltip">
                                <a href="stats.php">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-graph-down" viewBox="0 0 16 16">
                        ...
                        <li>
                            <div class="tooltip">
                                ...
                                <span class="tooltiptext">Jelenléti lapok generálása</span>
                            </div>
                        </li>
                        <li>
                            <div class="tooltip">
